...
GrantNavigator is a self-contained demonstration application for exploring potential European Research Council (ERC) grant matches. It provides separate views for researchers and research administrators. [vladislavivanistsev.github.io/GrantNavigator](https://vladislavivanistsev.github.io/GrantNavigator/)
